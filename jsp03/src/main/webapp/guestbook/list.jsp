	...
	<c:forEach var="dto" items="${list}">
		<form action="/jsp03/gb_servlet/passwd_check.do" method="post">
			...
			<table border="1" style="width: 600px">
				<tr>
					<td style="text-align: center; background-color: pink; width: 20%">이름</td>
					<td style="text-align: center; width: 30%">${dto.name}</td>
					<td
						style="text-align: center; background-color: pink; width: 20%">날짜</td>
					<td style="text-align: center; width: 30%">${dto.post_date}</td>
				</tr>
				<tr>
					<td style="text-align: center; background-color: yellow">이메일</td>
