...
function delete_product() {
	if(confirm("삭제하시겠습니까?")) {
		document.form1.action="/jsp03/admin_servlet/delete.do";
...
function update_product() {
	...
	document.form1.action="/jsp03/admin_servlet/update.do";
	document.form1.submit();
}
</script>
...
<tr>
<td>상품이미지</td>
<td><img src="/jsp03/images/${dto.filename}" width="300px" height="300px">
<br>
<input type="file" name="file1"></td>
</tr>
<tr>
<td colspan="2" align="center">
<input type="hidden" name="product_code" value="${dto.product_code}"> <!-- 수정삭제에 필요한 상품번호를 호출하기 위한 hidden input태그 -->
